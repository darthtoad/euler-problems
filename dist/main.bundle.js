...
var masterFirebaseConfig = {
    ...
    storageBucket: "euler-problems-971e9.appspot.com",
...
module.exports = "<h2>{{(problemToDisplay)?.number}}. {{(problemToDisplay)?.name}}</h2>\n<h4>{{(problemToDisplay)?.answer}}</h4>\n<h5>Solution</h5>\n<pre><p>{{(problemToDisplay)?.solution}}</p></pre>\n"
...
var ProblemDetailComponent = (function () {
    ...
    ProblemDetailComponent.prototype.ngOnInit = function () {
        ...
        this.problemService.getProblemById(this.problemId).subscribe(function (dataLastEmittedFromObserver) {
            _this.problemToDisplay = dataLastEmittedFromObserver;
        });
    };
